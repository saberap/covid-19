            ...
            <div className="container">
                <div className="section__wrapper py-10 relative">
                    <div className="flex-1">
                        <Image src="/static/assets/images/About.svg" alt="About covid 19" width={840} height={796} />
                    </div>
                    <div className="flex-1 p-36">
                        <h3 className="primary-color font-bold">What Is Covid-19</h3>
                        <h2 className="heading-color font-bold text-4xl mb-5">Coronavirus</h2>
                    ...
                    <div className="absolute bottom-0 right-5">
                        <Image src="/static/assets/images/Virus.svg" alt="Corona Virus" width={283} height={292} />
                    </div>
                </div>
            </div>
        </div>
